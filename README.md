...
Once the `conda-forge` channel has been enabled, `graphtools` can be installed with:

```
conda install graphtools
```

It is possible to list all of the versions of `graphtools` available on your platform with:
